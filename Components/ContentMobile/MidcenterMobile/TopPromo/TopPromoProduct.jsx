...
const TopPromoProduct = ({imgSrc, imgAlt, productName, productPrice, productFinalPrice, productId}) => {
  const returnFinalPrice = (priceValue) => {
    ...
    const finalPriceWithCommas = getProductFinalPrice.toString().replace('.', ',');
