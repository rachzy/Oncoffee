...
const Buttonsmo = () => {
  ...
  const switchLine = useRef(null);

  const handleHomeButtonClick = () => {
    conteudoSearch.classList.remove("active");
    switchLine.current.style.marginLeft = "3%";
  };
  ...
  const handleSearchButtonClick = () => {
    ...
    switchLine.current.style.marginLeft = "40%";
    window.scrollTo(0, 0);
  };

  const handleUserButtonClick = () => {
    conteudoSearch.classList.remove("active");
    switchLine.current.style.marginLeft = "75%";
  };
      ...
      <main className="switcher">
        <div className="buttonsarea">
          <label
            ...
            className="sbtt"
          >
            <img src={NewHomeIcon} alt="new-home-icon" />
          </label>
          <label onClick={handleSearchButtonClick} className="sbtt">
